...
\item Fatture\\È in BCNF perché IDfattura è chiave e perché a una pratica corrisponde un unico cliente (persona o organizzazione), come verificabile nello schema concettuale.
...
\begin{center}
\centering 
 \captionof{figure}{Piano di accesso logico della query 1}
\centerline{
%\frame{
\includegraphics[height=\textheight / 3]{ Albero logico 1.png }
}
\end{center}
\end{minipage}
...
\begin{center}
\centering 
 \captionof{figure}{Piano di accesso logico della query 2}
\centerline{
%\frame{
\includegraphics[height=\textheight / 3]{ Albero logico 2.png }
}
\end{center}
\end{minipage}
...
\begin{center}
\centering 
 \captionof{figure}{Piano di accesso logico della query 3}
\centerline{
%\frame{
\includegraphics[height=\textheight / 3]{ Albero logico 3.png }
}
\end{center}
\end{minipage}
...
\begin{center}
\centering 
 \captionof{figure}{Piano di accesso fisico della query 1 senza indici}
\centerline{
%\frame{
\includegraphics[height=\textheight / 3]{ Albero fisico 1.png }
}
\end{center}
\end{minipage}
...
\begin{center}
\centering 
 \captionof{figure}{Piano di accesso fisico della query 2 senza indici}
\centerline{
%\frame{
\includegraphics[height=\textheight / 3]{ Albero fisico 2.png }
}
\end{center}
\end{minipage}
...
\begin{center}
\centering 
 \captionof{figure}{Piano di accesso fisico della query 3 senza indici}
\centerline{
%\frame{
\includegraphics[height=\textheight / 3]{ Albero fisico 3.png }
}
\end{center}
\end{minipage}
...
\begin{center}
\centering 
 \captionof{figure}{Piano di accesso fisico della query 1 con indici}
\centerline{
%\frame{
\includegraphics[height=\textheight / 3]{ Albero fisico 1 indici.png }
}
\end{center}
\end{minipage}
...
\begin{center}
\centering 
 \captionof{figure}{Piano di accesso fisico della query 2 con indici}
\centerline{
%\frame{
\includegraphics[height=\textheight / 3]{ Albero fisico 2 indici.png }
}
\end{center}
\end{minipage}
...
\begin{center}
\centering 
 \captionof{figure}{Piano di accesso fisico della query 3 con indici}
\centerline{
%\frame{
\includegraphics[height=\textheight / 3]{ Albero fisico 3 indici.png }
}
\end{center}
\end{minipage}
