...
\title { \centering\includegraphics[width=3cm]{ Stemma_unipi.png }\\{\small Università di Pisa\\Dipartimento di Informatica\\Corso di Laurea in Informatica\\[0.5cm]Corso di Basi di Dati (244AA), prof. Giorgio Ghelli\\[0.7cm]}Progetto ``Studio professionale fatture"\\Relazione finale }
...
\null \vfill
\lstinputlisting[basicstyle=\footnotesize,nolol]{1.sql}
\vfill \null
...
\null \vfill
\lstinputlisting[basicstyle=\footnotesize,nolol]{2.sql}
\vfill \null
...
\null \vfill
\lstinputlisting[basicstyle=\footnotesize,nolol]{3.sql}
\vfill \null
...
%\centerline{
%\frame{
\includegraphics[height=6.2cm]{ Albero fisico indici 1.png }
%}
%\end{center}
...
%\centerline{
%\frame{
\includegraphics[height=10cm]{ Albero fisico indici 2.png }
%}
%\end{center}
